          ...
          return (
            <div key={index} className="bg-white rounded-lg border border-gray-200 p-4 lg:p-6 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-center justify-between">
                ...
                <div className={`p-2 lg:p-3 rounded-full ${colorClasses[2]}`}>
                  <Icon className={`w-5 h-5 lg:w-6 lg:h-6 ${colorClasses[1]}`} />
                </div>
              </div>
            </div>
          );
            ...
            <div className="space-y-3 max-h-80 overflow-y-auto">
              {stats.recentConsultations.length > 0 ? (
                stats.recentConsultations
                  ...
                  .map((consultation) => (
                  <div key={consultation.id} className="flex flex-col sm:flex-row sm:items-center justify-between p-3 bg-gray-50 rounded-lg space-y-2 sm:space-y-0">
            ...
            <div className="space-y-3 max-h-80 overflow-y-auto">
              {stats.lowStockProducts.length > 0 ? (
                stats.lowStockProducts.map((product) => (
                  <div key={product.id} className="flex flex-col sm:flex-row sm:items-center justify-between p-3 bg-red-50 rounded-lg border border-red-200 space-y-2 sm:space-y-0">
                    <div className="flex-1">
