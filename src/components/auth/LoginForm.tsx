    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 py-4 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-4 sm:space-y-6 lg:space-y-8">
        <div className="text-center">
          ...
          <h2 className="mt-3 sm:mt-4 lg:mt-6 text-xl sm:text-2xl lg:text-3xl font-extrabold text-gray-900">
            CliniqueManager
          </h2>
        ...
        <form className="mt-4 sm:mt-6 lg:mt-8 space-y-4 sm:space-y-6" onSubmit={handleSubmit}>
          <div className="bg-white p-4 sm:p-6 lg:p-8 rounded-xl shadow-lg">
            {error && (
              <div className="mb-3 sm:mb-4 p-3 bg-red-100 border border-red-400 text-red-700 rounded-md text-sm">
                {error}
              </div>
            )}
            ...
            <div className="space-y-3 sm:space-y-4 lg:space-y-6">
              <div>
                ...
                <input
                  ...
                  className="block w-full px-3 sm:px-4 py-2 sm:py-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-sm sm:text-base"
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="block w-full px-3 sm:px-4 py-2 sm:py-3 pr-10 sm:pr-12 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-sm sm:text-base"
