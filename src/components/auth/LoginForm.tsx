              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="block w-full px-4 py-3 pr-12 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-base"
