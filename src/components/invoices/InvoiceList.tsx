                ...
                <div className="flex items-start justify-between mb-3">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center mb-2">
                      ...
                      <span className="text-lg font-medium text-gray-900">{invoice.invoice_number}</span>
                    </div>
                    <h3 className="text-base font-medium text-gray-900 truncate mb-1">
                      {invoice.patient?.first_name} {invoice.patient?.last_name}
                    </h3>
                    {invoice.patient?.phone && (
                      <p className="text-sm text-gray-600 truncate">{invoice.patient.phone}</p>
                    )}
                  </div>
        ...
        <div className="bg-white p-4 lg:p-6 rounded-lg border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl lg:text-2xl font-bold text-gray-900">{invoices.length}</p>
            </div>
