                ...
                <div key={product.id} className="p-4 hover:bg-gray-50">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center space-x-4 text-sm">
                        ...
                        <div className="flex items-center text-green-600">
                          ...
                          <span className="font-medium">{product.unit_price}€/{product.unit}</span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {product.expiry_date && (
                      <div className="text-right">
                        ...
                        {expired && <p className="text-xs text-red-600">Expiré</p>}
                        {expiringSoon && !expired && <p className="text-xs text-yellow-600">Expire bientôt</p>}
                      </div>
                    )}
                  </div>
                  ...
                  {product.barcode && (
                    <div className="mt-2 pt-2 border-t border-gray-100">
                      <p className="text-xs text-gray-400 font-mono">Code: {product.barcode}</p>
                    </div>
                  )}
                </div>
              );
